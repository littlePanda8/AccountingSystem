...
abstract class User {
    ...
    public abstract void menu(SystemManager systemManager);
}
...
class Reporter extends User {
    ...
    public void submitReport(SystemManager systemManager) {
    ...
    @Override
    public void menu(SystemManager systemManager) {
...
class Admin extends User {
    ...
    public void viewAllReports(SystemManager systemManager) {
    ...
    public void updateReportStatus(SystemManager systemManager) {
...
public class SystemManager {
    ...
    public SystemManager() {
        ...
        users.add(new Reporter("john", "pass"));
    }
    ...
    public void start() {
        while(true) {
            ...
            int choice = JOptionPane.showOptionDialog(
                    null,
                    "Welcome to Barangay Reporting System",
                    "System",
